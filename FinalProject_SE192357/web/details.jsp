    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="article-content">
                <%
                    // Check if request is from ManageArticles
                    Object fromManageArticles = request.getAttribute("fromManageArticles");
                    if (fromManageArticles != null && (boolean) fromManageArticles) {
                %>
                ...
                <div class="article-thumbnail-container">
                    <img src="<%= article.getThumbnail() != null ? article.getThumbnail() : ""%>" alt="<%= article.getTitle()%>" class="article-thumbnail">
                </div>
